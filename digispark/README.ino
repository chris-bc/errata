...
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("Other drivers & boards");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("- If you get interested in other dev boards/chips it's a good idea to install drivers for both the CH340 and CP2101 chips at the same time");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("  - USB is how computers communicate, UART is how chips communicate");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("  - The CH340 and CP210x series of chips translate between the two");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("  - It can be VERY hard to figure out what causes \"absolutely nothing is happening\" issues, installing them both up front will make future Eleni less frustrated.");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.sendKeyStroke(KEY_ENTER);
...
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("      - Remote controls - garage doors, toys, drones, doorbells, car keys, etc.");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("      - Air traffic control data");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("      - Audio and, occasionally, images from the International Space Station");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
DigiKeyboard.println("      - GSM, GPS, pagers, baby monitors, weather balloons, IoT sensors/stations");
DigiKeyboard.sendKeyStroke(KEY_ENTER);
